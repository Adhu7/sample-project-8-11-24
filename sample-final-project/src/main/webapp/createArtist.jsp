...
<div class="container mt-4">
    ...
    <form action="#" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="email" class="form-control" id="artist-email" name="contactEmail" required>
        </div>

        <!-- Contact Phone -->
        <div class="mb-3">
            <label for="artist-phone" class="form-label">Contact Phone</label>
            <input type="tel" class="form-control" id="artist-phone" name="contactPhone" required>
        </div>
