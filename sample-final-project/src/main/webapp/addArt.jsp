...
<div class="main-content">
    ...
    <div class="content-wrapper">
        ...
        <!-- Add Artwork Form -->
        <form action="uploadArtwork.jsp" method="post" enctype="multipart/form-data">
            <!-- Artwork Title -->
            <div class="mb-3">
                <label for="art-title" class="form-label">Artwork Title</label>
                <input type="text" class="form-control" id="art-title" name="title" required>
            </div>

            <!-- Artist Name -->
            <div class="mb-3">
                <label for="artist-name" class="form-label">Artist Name</label>
                <input type="text" class="form-control" id="artist-name" name="artistName" required>
            </div>

            <!-- Genre -->
            <div class="mb-3">
                <label for="art-genre" class="form-label">Genre</label>
                <select class="form-control" id="art-genre" name="genre" required>
            ...
            <!-- Dimensions -->
            <div class="mb-3">
                <label for="art-dimensions" class="form-label">Dimensions (e.g., 24x36 inches)</label>
                <input type="text" class="form-control" id="art-dimensions" name="dimensions" required>
            </div>

            <!-- Price -->
            <div class="mb-3">
                <label for="art-price" class="form-label">Price (Rs.)</label>
                <input type="number" class="form-control" id="art-price" name="price" required>
            </div>

            <!-- Artwork Image -->
            <div class="mb-3">
                <label for="art-image" class="form-label">Upload Image</label>
                <input type="file" class="form-control" id="art-image" name="image" accept="image/*" required>
            </div>
